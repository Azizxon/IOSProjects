...
protocol PhotoViewDelegate: class {
    func photoViewDidChange(_ sender: PhotoView)
}

extension Notification.Name {
    static let photoViewDidChange = Notification.Name("photoViewDidChange")
}

class PhotoView: UIView, UIDropInteractionDelegate
{
    // MARK: - Initialization
    ...
    func addLabel(with attributedString: NSAttributedString,
        ...
        label.sizeToFit()
        label.center = point
        addPhotoGestureRecognizers(to: label)
        addSubview(label)
    }
